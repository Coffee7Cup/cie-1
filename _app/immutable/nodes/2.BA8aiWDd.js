...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:fi,depthTest:!1,depthWrite:!1})}function Eh(){return new gi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xo(),fragmentShader:`
		...
		`,blending:fi,depthTest:!1,depthWrite:!1})}function Ah(){return new gi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xo(),fragmentShader:`
...
`].filter(Ls).join(`
`)),a=oc(a),a=Oh(a,t),a=Bh(a,t),o=oc(o),o=Oh(o,t),o=Bh(o,t),a=kh(a),o=kh(o),t.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
`)+`
`+p);const b=v+m+a,y=v+p+o,T=Nh(i,i.VERTEX_SHADER,b),E=Nh(i,i.FRAGMENT_SHADER,y);i.attachShader(x,T),i.attachShader(x,E),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function w(P){if(s.debug.checkShaderErrors){const I=i.getProgramInfoLog(x)||"",N=i.getShaderInfoLog(T)||"",B=i.getShaderInfoLog(E)||"",V=I.trim(),z=N.trim(),q=B.trim();let G=!0,$=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(G=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,T,E);else{const j=Fh(i,T,"vertex"),ue=Fh(i,E,"fragment");Ge("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
"><h1 class="text-4xl lg:text-[6.5rem] font-bold text-anim relative z-[3] font-notable">CENTER FOR <br/> INNOVATION AND <br/> ENTREPRENEURSHIP</h1></div>`,1);function cS(s,e){Mi(e,!1),na(()=>{let r=new pp(".text-anim",{type:"chars, words"});zs.from(r.chars,{y:30,opacity:0,stagger:.05,duration:.4,ease:"power3.out"})}),yf();var t=lS(),n=Xt(Xr(t),2),i=Xt(Tt(n),2);oS(i,{}),Mt(n),kp(2),Ut(s,t),yi()}var uS=Cc('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>');function hS(s,e){let t=ls(e,"inline",8,!0);const n="width:1em;position:relative;top:0.15em;";var i=uS();mi(()=>ia(i,t()?n:void 0)),Ut(s,i)}var fS=Cc('<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>');function dS(s,e){let t=ls(e,"inline",8,!0);const n="width:1em;position:relative;top:0.15em;";var i=fS();mi(()=>ia(i,t()?n:void 0)),Ut(s,i)}var pS=xn(`<button class="
	...
	"><span> </span></div> <div class="
		...
		pointer-events-none
	"><!></div>`,1);function yS(s,e){Mi(e,!0);let t=Br(()=>e.scrollDirection==="down"?co:uo),n=Br(()=>e.scrollDirection==="down"?uo:co);var i=MS(),r=Xr(i),a=Tt(r),o=Tt(a,!0);Mt(a),Mt(r);var l=Xt(r,2),c=Tt(l),u=Tt(c,!0);Mt(c),Mt(l);var h=Xt(l,2),f=Tt(h);{let d=Br(()=>[qn[e.currentIndex-1].description]);bS(f,{speed:300,get text(){return ze(d)},get key(){return e.currentIndex},get scrollDirection(){return e.scrollDirection}})}Mt(h),mi(()=>{qr(o,qn[e.currentIndex-1].name[0]),qr(u,qn[e.currentIndex-1].description_fr)}),rr(2,r,()=>ze(t)),rr(1,r,()=>ze(n)),rr(2,l,()=>ze(t)),rr(1,l,()=>ze(n)),Ut(s,i),yi()}var SS=xn(`<div class="wavy-circle pointer-events-none
...
&lt;!--				hover:opacity-100-->
			...
			" aria-label="ss"></button>`,1);function RS(s,e){Mi(e,!0);let t=null;function n(d){t&&(t.style.display="block",i(d))}function i(d){t&&(t.style.left=`${d.clientX+15}px`,t.style.top=`${d.clientY-50}px`)}function r(){t&&(t.style.display="none")}var a=wS(),o=Xr(a),l=Tt(o),c=Tt(l),u=Xt(c),h=Tt(u);AS(h,{inline:!1}),Mt(u),Mt(l),Mt(o),xi(o,d=>t=d,()=>t);var f=Xt(o,2);f.__mousemove=i,f.__click=()=>{Yp(Wp(`${qn[e.currentIndex-1].route}`)),console.log(`${qn[e.currentIndex-1].name}`)},mi(()=>{qr(c,`${(e.currentIndex!==0?qn[e.currentIndex-1].name:"Home")??""} `),ia(f,e.currentIndex!==0?"display : hidden":"display : none;")}),Au("mouseenter",f,d=>n(d)),Au("mouseleave",f,r),Ut(s,a),yi()}bf(["mousemove","click"]);const Cs=Gp(0);var CS=xn('<div class="relative w-full h-full"><!></div>'),PS=xn('<div class="fixed w-full h-full overflow-hidden pointer-events-none"></div> <!> <!> <!> <div class="relative w-full h-full"><!></div> <!>',1);function zS(s,e){Mi(e,!0);const t=()=>Xp(Cs,"$heroIndex",n),[n,i]=qp();let r=Br(()=>qn[t()-1]?.complementaryColor||"#ffffff"),a=Hp([]),o=Ba(null),l=null,c=Ba(!1),u=Ba(0);const h=200;function f(R){if(ze(c))return;let g=t();R==="down"&&t()<a.length-1?g=t()+1:R==="up"&&t()>0&&(g=t()-1),g!==t()&&(Pn(c,!0),Pn(o,R,!0),ca(Cs,g),Pn(u,0),setTimeout(()=>{Pn(c,!1)},500))}function d(R){R.preventDefault(),!ze(c)&&(Pn(u,ze(u)+R.deltaY),ze(u)>=h?f("down"):ze(u)<=-h&&f("up"),(ze(u)>0&&R.deltaY<0||ze(u)<0&&R.deltaY>0)&&Pn(u,R.deltaY,!0))}function _(R){R.touches.length===1&&(l=R.touches[0].clientY)}function x(R){if(l===null||ze(c))return;const g=R.changedTouches[0].clientY;let S=l-g;S>50?f("down"):S<-50&&f("up"),l=null}Rc(()=>{a[t()]&&a[t()].scrollIntoView({behavior:"smooth"})}),na(()=>(window.addEventListener("wheel",d,{passive:!1}),window.addEventListener("touchstart",_,{passive:!1}),window.addEventListener("touchend",x,{passive:!1}),()=>{window.removeEventListener("wheel",d),window.removeEventListener("touchstart",_),window.removeEventListener("touchend",x)}));var m=PS(),p=Xr(m),v=Xt(p,2);RS(v,{get currentIndex(){return So(),t()},set currentIndex(R){ca(Cs,R)}});var b=Xt(v,2);TS(b,{get scrollDirection(){return ze(o)},get currentIndex(){return So(),t()},set currentIndex(R){ca(Cs,R)}});var y=Xt(b,2);_S(y,{get currentIndex(){return So(),t()},set currentIndex(R){ca(Cs,R)}});var T=Xt(y,2),E=Tt(T);cS(E,{}),Mt(T),xi(T,R=>a[0]=R,()=>a?.[0]);var w=Xt(T,2);Pc(w,17,()=>qn,Lc,(R,g,S)=>{var P=CS(),I=Tt(P);GM(I,{get name(){return ze(g)._3d_name},get settings(){return ze(g).settings}}),Mt(P),xi(P,(N,B)=>a[B+1]=N,N=>a?.[N+1],()=>[S]),Ut(R,P)}),mi(()=>ia(p,`background-color: ${ze(r)??""}; transition: background-color 1s ease;`)),Ut(s,m),yi(),i()}export{zS as component};
